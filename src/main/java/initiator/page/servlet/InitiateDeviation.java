...
public class InitiateDeviation extends HttpServlet {
    ...
    // Assuming you have a mechanism to obtain a Connection object (e.g., from a connection pool)
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String jsonResponse = new Gson().toJson(new StandardResponse("success", "Deviation initiated successfully."));
    ...
    public void init() throws ServletException {
        ...
        // Example: deviationDAO = new DeviationDAO((Connection) getServletContext().getAttribute("DBConnection"));
    }

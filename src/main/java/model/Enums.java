...
public class Enums {
    ...
    public enum DeviationStatus {
        APPROVED_BY_QA, UNDER_CFT_REVIEW, PENDING_CFT_REVIEW, OPEN, UNDER_REVIEW, CLOSED, REJECTED, ONGOING_DEPARTMENT_REVIEW, PENDING_DEPARTMENT_REVIEW, PENDING_FINAL_APPROVAL, PENDING_QA_REVIEW
    }
    ...
    public enum RiskFactorType {
        PROCESS_STEPS, MICROBIOLOGICAL, CROSS_CONTAMINATION, PRODUCT_IMPACT, INVESTIGATION_COMPLEXITY, QUALITY_CRITICAL, PROBABILITY
    }
}
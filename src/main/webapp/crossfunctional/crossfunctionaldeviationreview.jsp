		...
		<div class="page-wrapper">
			...
			<div class="body-wrapper">
				<div class="container-fluid mw-100">
					...
					<div class="card" id="DeviationDetails">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DepartmentalFeedback">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="RequestFurtherActions">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="ReviewSubmission">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DocumentationAndAudit">
						<div class="card-body">

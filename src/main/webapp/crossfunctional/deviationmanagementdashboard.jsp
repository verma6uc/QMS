		...
		<div class="page-wrapper">
			...
			<div class="body-wrapper">
				<div class="container-fluid mw-100">
					...
					<div class="card" id="ActiveDeviationsList">
						<div class="card-body">
							
						</div>
					</div>
					<div class="card" id="MyDeviationTasks">
						<div class="card-body">
							
						</div>
					</div>
					<div class="card" id="AlertsandNotifications">
						<div class="card-body">
							
						</div>
					</div>
					<div class="card" id="DeviationQuickActions">
						<div class="card-body">
							
						</div>
					</div>
					<div class="card" id="HistoricalDeviationAnalysis">
						<div class="card-body">

		...
		<div class="page-wrapper">
			...
			<div class="body-wrapper">
				<div class="container-fluid mw-100">
					...
					<div class="card" id="InvestigationInitialization">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="EvidenceAndDataCollection">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="RootCauseAnalysis">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DetailedObservations">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="FinalFindingsAndRecommendations">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="SubmitForReview">
						<div class="card-body">

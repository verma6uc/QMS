		...
		<div class="page-wrapper">
			...
			<div class="body-wrapper">
				<div class="container-fluid mw-100">
					...
					<div class="card" id="CapaSetup">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DetailedActionPlanning">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="CapaRiskAssessment">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="MonitoringAndEffectiveness">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="CapaDocumentationAndSignOff">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="CapaStatusAndUpdates">
						<div class="card-body">

		...
		<div class="page-wrapper">
			...
			<div class="body-wrapper">
				<div class="container-fluid mw-100">
					...
					<div class="card" id="DeviationReportingOverview">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DetailedDeviationAnalysis">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DeviationResolutionDocumentation">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="ExportDeviationData">
						<div class="card-body">

		...
		<div class="page-wrapper">
			...
			<div class="body-wrapper">
				<div class="container-fluid mw-100">
					...
					<div class="card" id="DeviationReviewSummary">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="CapaEffectivenessCheck">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="FinalRiskConfirmation">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DeviationClosureApproval">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DocumentationAndArchival">
						<div class="card-body">
					...
					<div class="card" id="ClosureNotification">
						<div class="card-body">

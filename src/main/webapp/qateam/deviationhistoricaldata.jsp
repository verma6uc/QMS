		...
		<div class="page-wrapper">
			...
			<div class="body-wrapper">
				<div class="container-fluid mw-100">
					...
					<div class="card" id="DeviationSearchPanel">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="HistoricalDeviationsList">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DeviationTrendAnalysis">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DataExportTools">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="RelatedDocumentation">
						<div class="card-body">

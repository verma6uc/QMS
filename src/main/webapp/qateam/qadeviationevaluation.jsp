		...
		<div class="page-wrapper">
			...
			<div class="body-wrapper">
				<div class="container-fluid mw-100">
					...
					<div class="card" id="DeviationResponseReview">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="RiskManagementReview">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="ComplianceVerification">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="FinalReviewAndApproval">
						<div class="card-body">
							
						</div>
					</div>
					
					<div class="card" id="DocumentationAndAuditTrail">
						<div class="card-body">
